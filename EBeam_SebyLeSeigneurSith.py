...
if __name__ == '__main__':
    ...
    DeEmbeddingStructure = topCell << pdk.add_fiber_array(grating_coupler= pdk.gc_te1550, name = 'DeEmbeddingStructure', with_loopback=False, gc_port_labels = ["out", "opt_in_TE_1550_SebyleSeigneurSith_DeEmbeddingStructure"], layer_label = (10,0), fanout_length = 1, straight_separation = 0)
